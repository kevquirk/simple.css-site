...
permalink: /simple-css-version-2/
---
...
Finally, I just wanted to say thank you to all the people have contributed to Simple.css, and continue to do so. I never expected Simple.css to go anywhere - it was just a fun little personal project that I ended up published. So to see other people finding it useful and using it in the wild really warms my heart.
